    ...
    <svg
      ...
      <defs>
        <linearGradient id="chem-g" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#ff331f" />
          <stop offset="100%" stopColor="#ff6655" />
        </linearGradient>
        <filter id="chem-glow">
        ...
        <radialGradient id="chem-atom" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#ff331f" stopOpacity="0.6" />
          <stop offset="100%" stopColor="#ff331f" stopOpacity="0" />
        </radialGradient>
      </defs>

      <ellipse cx="120" cy="120" rx="100" ry="32" fill="none"
        stroke="#ff331f" strokeWidth="0.4" opacity="0.12" strokeDasharray="3 5">
        <animateTransform attributeName="transform" type="rotate"
          from="0 120 120" to="360 120 120" dur="20s" repeatCount="indefinite" />
      </ellipse>
      <ellipse cx="120" cy="120" rx="88" ry="38" fill="none"
        stroke="#ff6655" strokeWidth="0.3" opacity="0.08">
        <animateTransform attributeName="transform" type="rotate"
      ...
      <polygon points="120,74 149,89 149,119 120,134 91,119 91,89"
        fill="none" stroke="#ff331f" strokeWidth="0.8" opacity="0.25" />

      <line x1="120" y1="59" x2="160" y2="83" stroke="#ff331f" strokeWidth="0.4" opacity="0.2" />
      <line x1="160" y1="129" x2="120" y2="153" stroke="#ff331f" strokeWidth="0.4" opacity="0.2" />
      <line x1="80" y1="83" x2="80" y2="129" stroke="#ff331f" strokeWidth="0.4" opacity="0.2" />
      ...
      {([
        ...
        <g key={i}>
          ...
          <circle cx={cx} cy={cy} r="3.5" fill="#ff331f" opacity="0.9">
      ...
      {([
        ...
        <g key={`bond-${i}`}>
          <line x1={x1} y1={y1} x2={x2} y2={y2} stroke="#ff331f" strokeWidth="1" opacity="0.35" />
          <circle cx={x2} cy={y2} r="2.5" fill="#ff6655" opacity="0.5" />
        </g>
      ))}

      <circle r="2" fill="#ff331f" opacity="0.7" filter="url(#chem-glow)">
        <animateMotion dur="6s" repeatCount="indefinite"
          path="M 20,120 Q 120,50 220,120 Q 120,190 20,120 Z" />
      </circle>
      <circle r="1.5" fill="#ff6655" opacity="0.5">
